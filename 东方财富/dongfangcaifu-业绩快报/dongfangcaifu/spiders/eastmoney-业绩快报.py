...
class EastmoneySpider(scrapy.Spider):
    ...
    def start_requests(self):
        for i in range(0,100):
            list_url =  'http://dcfm.eastmoney.com//em_mutisvcexpandinterface/api/js/get?type=NBJB_YJBB_N&token=70f12f2f4f091e459a279469fe49eca5&st=NOTICEDATE&sr=-1&p='+str(i)+'&ps=50&js=var%20MwkcNOoL={pages:(tp),data:%20(x)}&filter=(REPORTDATE=^2017-12-31^)&rt=50689316'
